...
namespace Tests2ElectricBoogaloo
{
	[TestFixture]
    public class WriterTest
    {
        ...
        private static ILoadBalancer testLB = new LoadBalancerClass(2, logger);
        ...
        {
            ILoadBalancer loadBalancer = new LoadBalancerClass(2, logger);
            ...
            var a = loadBalancer.GetBuffer();
            Assert.AreEqual(loadBalancer.GetBuffer().Count, 0);
        }
